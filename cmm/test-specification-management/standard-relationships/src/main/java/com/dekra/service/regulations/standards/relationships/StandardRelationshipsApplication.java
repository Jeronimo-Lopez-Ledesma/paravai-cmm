package com.dekra.service.regulations.standards.relationships;
...
@ComponentScan(basePackages = {
		"com.dekra.service.regulations.standards.relationships",
...
public class StandardRelationshipsApplication {

	public static void main(String[] args) {

		Logger log = LoggerFactory.getLogger(StandardRelationshipsApplication.class);
		log.info("PRUEBA DE LOG ACTIVA");
		SpringApplication.run(StandardRelationshipsApplication.class, args);
	}
	...
	CommandLineRunner testMessages(MessageSource messageSource) {
		return args -> {
			String message = messageSource.getMessage("standards.relationshipType.REPLACES", null, Locale.ENGLISH);
