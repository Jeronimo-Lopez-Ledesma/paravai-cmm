...
public abstract class JsonApiErrorPactTest {

    private final String consumerName;
    private final String providerName;

    protected JsonApiErrorPactTest(String consumerName, String providerName) {
    ...
    /** Each subclass defines the message */
    ...
    public V4Pact createPact(PactDslWithProvider builder) {
        ...
        if(hasDetails()){
            responseBody = (PactDslJsonBody) new PactDslJsonBody()
                    .object("error")
                    .stringType("code", String.valueOf(getStatus()))
                    .stringType("message", getMessage())
                    .array("details")
                    .minArrayLike(0, resourceDsl())
                    .closeArray()
                    .closeObject();
        }else{
            responseBody = (PactDslJsonBody) new PactDslJsonBody()
                    ...
                    responseBody.nullValue("details");
        ...
        if (hasGivenState()) {
            pact = builder
                    .given(getGivenState())
                    .uponReceiving("JsonApiErrorPactTest " + getInteractionName() + " test interaction")
                    .path(getPath())
                    .method(getMethod());
        } else {
            pact = builder
