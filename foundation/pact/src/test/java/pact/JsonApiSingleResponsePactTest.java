...
public abstract class JsonApiSingleResponsePactTest {

    private final String consumerName;
    private final String providerName;

    protected JsonApiSingleResponsePactTest(String consumerName, String providerName) {
    ...
    public V4Pact createPact(PactDslWithProvider builder) {
        ...
        if (hasGivenState()) {
            pact = builder
                    .given(getGivenState())
                    .uponReceiving("JsonApiSingleResponsePactTest " + getInteractionName() +" test interaction")
                    .path(getPath())
                    .method(getMethod());
        } else {
            pact = builder
